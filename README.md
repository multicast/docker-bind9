...
# Packages
    ...
    ii  bind9                      1:9.11.5.P4+dfsg-5.1+deb10u3 amd64        Internet Domain Name Server
    ii  bind9-host                 1:9.11.5.P4+dfsg-5.1+deb10u3 amd64        DNS lookup utility (deprecated)
    ii  bind9utils                 1:9.11.5.P4+dfsg-5.1+deb10u3 amd64        Utilities for BIND
    ...
    ii  dnsutils                   1:9.11.5.P4+dfsg-5.1+deb10u3 amd64        Clients provided with BIND
    ...
    ii  libdns1104:amd64           1:9.11.5.P4+dfsg-5.1+deb10u3 amd64        DNS Shared Library used by BIND
    ...
    ii  libirs161:amd64            1:9.11.5.P4+dfsg-5.1+deb10u3 amd64        DNS Shared Library used by BIND
    ii  libisc1100:amd64           1:9.11.5.P4+dfsg-5.1+deb10u3 amd64        ISC Shared Library used by BIND
    ii  libisccc161:amd64          1:9.11.5.P4+dfsg-5.1+deb10u3 amd64        Command Channel Library used by BIND
    ii  libisccfg163:amd64         1:9.11.5.P4+dfsg-5.1+deb10u3 amd64        Config File Handling Library used by BIND
    ...
    ii  liblwres161:amd64          1:9.11.5.P4+dfsg-5.1+deb10u3 amd64        Lightweight Resolver Library used by BIND
    ...
    ii  libssl1.1:amd64            1.1.1d-0+deb10u5             amd64        Secure Sockets Layer toolkit - shared libraries
