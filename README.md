...
# Packages
    ...
    ii  git                        1:2.20.1-2+deb10u5           amd64        fast, scalable, distributed revision control system
    ii  git-man                    1:2.20.1-2+deb10u5           all          fast, scalable, distributed revision control system (manual pages)
